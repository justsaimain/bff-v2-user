...
export default {
  ...
  methods: {
    ...
    showPredictionForm(fixture) {
      ...
      this.predictionForm.finished_provisional = fixture.finished_provisional;
  ...
  mounted() {
    ...
    this.totalGameWeek = this.options.total_gameweek;
    this.gameWeek = this.options.current_gameweek;
